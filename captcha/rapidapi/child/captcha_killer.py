...
class CaptchaKiller(BaseRapidapi):
    api_url = 'https://captchakiller1.p.rapidapi.com/solvev2e'
    key_api_params_url = "site"
    key_api_params_sitekey = 'sitekey'
    params = {
        "gdomain": "false", "invisible": "false"
    }
